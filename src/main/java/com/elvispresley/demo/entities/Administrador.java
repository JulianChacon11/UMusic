...
public class Administrador implements Serializable {
    ...
    public Administrador(int id, String name, String lastName, String email, 
            LocalDate dateOfBirth, String phone, String gender, String nationality, 
            boolean userStatus) {
        this.id = id;
        this.name = name;
    ...
    public Administrador(String name, String lastName, String email, LocalDate dateOfBirth, 
